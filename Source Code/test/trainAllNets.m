%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                                                           %%%
%%%    This File Is Used To Train All The Neural Networks     %%%
%%%                                                           %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function trainAllNets()

load trainingChars;           % Loading The Characters That Are Used To Train The Neural Networks
%load upChars;

%%%__________________________________%%%
%%%   Training Neural Network No. 1  %%%
%%%__________________________________%%%
...
net1.trainParam.show = 40;      % Frequency of progress displays (in epochs).
net1.trainParam.epochs = 7000;  % Maximum number of epochs to train.
net1.trainParam.mc = 0.7;       % Momentum constant.

[net1] = train(net1,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 2  %%%
%%%__________________________________%%%
...
[net2] = train(net2,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 3  %%%
%%%__________________________________%%%
...
S1 = 5;                     % No. of Neurons in the HIDDEN Layer   
S2 = w;                     % No. of Neurons in the OUTPUT Layer
...
[net3] = train(net3,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 4  %%%
%%%__________________________________%%%
...
[net4] = train(net4,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 5  %%%
%%%__________________________________%%%
...
[net5] = train(net5,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 6  %%%
%%%__________________________________%%%
...
[net6] = train(net6,alphabet,targets);    %    Training begins...please wait...


%%%__________________________________%%%
%%%   Training Neural Network No. 7  %%%
%%%__________________________________%%%
...
[net7] = train(net7,alphabet,targets);    %   Training begins...please wait...
...
save('trainedNeuralNets','net1','net2','net3','net4','net5','net6','net7');
%save('trainedNeuralNets','net8');
